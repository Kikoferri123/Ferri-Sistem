...
import { getTransactionsOut, getTransactionsOutSummary, createTransactionOut, updateTransactionOut, deleteTransactionOut, getProperties, getCategoriesOut, getPaymentMethods } from '../services/api';
...
export default function TransactionsOutPage() {
  ...
  const load = () => {
    ...
    getTransactionsOutSummary(params).then(r => { setServerTotal(r.data.total_amount); setTotalCount(r.data.count); }).catch(() => {});
  };
